  ...
  nixarr-command = pkgs.writeShellApplication {
    ...
    text = ''
      ...
      wipe-uids-gids() {
        ...
        sed -i -E '/^(anchorr|audiobookshelf|autobrr|bazarr|cross-seed|jellyfin|jellyseerr|seerr|lidarr|plex|prowlarr|radarr|readarr|recyclarr|sabnzbd|sonarr|streamer|torrenter|transmission|usenet|whisparr|komgarr)/d' /etc/passwd
        sed -i -E '/^(anchorr|autobrr|cross-seed|jellyseerr|seerr|media|prowlarr|recyclarr|sabnzbd|streamer|torrenter|transmission|usenet)/d' /etc/group
